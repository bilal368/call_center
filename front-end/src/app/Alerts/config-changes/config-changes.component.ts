...
@Component({
  ...
  imports: [MatCheckboxModule,FormsModule,CommonModule,TranslateModule,MatIconModule,MatButtonModule,
    MatMenuModule,SearchPipe,MatTooltipModule],
  templateUrl: './config-changes.component.html',
  styleUrl: './config-changes.component.css'
})
export class ConfigChangesComponent {
  buildDiv: string = 'Recorder Settings';
